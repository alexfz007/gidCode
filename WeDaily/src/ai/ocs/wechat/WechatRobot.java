...
import ai.ocs.wechat.listener.WechatListener;
import ai.ocs.wechat.model.WechatMeta;
import ai.ocs.wechat.service.WechatService;
import ai.ocs.wechat.service.WechatServiceImpl;
import ai.ocs.wechat.ui.QRCodeFrame;
import ai.ocs.wechat.util.CookieUtil;
...
public class WechatRobot {
	...
	public void start() throws WechatException {
	  ...
	  LOGGER.warn("日报填写助手启动");
		...
		LOGGER.warn("开启状态通知成功");
		
		LOGGER.warn("获取联系人...");
		Constant.CONTACT = wechatService.getContact(wechatMeta);
		LOGGER.warn("获取联系人成功");
		LOGGER.warn("共有 {} 位联系人", Constant.CONTACT.getContactList().size());
